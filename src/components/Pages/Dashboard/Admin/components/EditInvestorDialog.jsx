...
export default function EditInvestorDialog({ isOpen, onClose, onSubmit, formData, setFormData }) {
      ...
      <div className="bg-gray-800 p-6 rounded-lg w-full max-w-3xl max-h-full overflow-y-auto hide-scrollbar">
        ...
        <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }}>
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <button type="submit" className="px-4 py-2 bg-blue-600 rounded hover:bg-blue-700">Update Investor</button>
          </div>
        </form>
      </div>
    </div>
